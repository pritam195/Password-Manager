...
const Password = () => {
    ...
    const handleUnlock = async () => {
        try {
            const res = await axios.post("https://password-manager-m7r4.onrender.com/getpass", {
                email: key,
                secretKey
    ...
    const deletePassword = async (id) => {
        ...
        try {
            await axios.delete(`https://password-manager-m7r4.onrender.com/delete/${id}`, { withCredentials: true });
    ...
    const editPassword = async (id) => {
        ...
        try {
            await axios.put(`https://password-manager-m7r4.onrender.com/update/${id}`, {
